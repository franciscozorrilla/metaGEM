...
Please consult the setup page in the wiki for further configuration instructions, as well as the [manual setup guide](https://github.com/franciscozorrilla/metaGEM/wiki/Manual-setup).
